	...
	render:function(){
		return(
			React.createElement("form", {onSubmit: this.handleSubmit}, 
				...
				React.createElement("input", {type: "text", placeholder: "your words", value: this.state.text, onChange: this.handleTextChange}), React.createElement("input", {type: "button", value: "post"})
				)
			);
	}
})
